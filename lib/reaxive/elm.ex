defmodule Reaxive.Elm do

	@moduledoc """
	This module contains reactive implementations that follow the interface design 
	of the ELM language. 

	Currently, it does not work properly as the termination of computations is not 
	handled correctly.
	"""
